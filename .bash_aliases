...
# PKG=json-conv; BINS=(json2yaml yaml2json toml2json json2toml json2csv csv2json); { [[ -d ~/.$PKG-venv ]] || python -m venv ~/.$PKG-venv; } && { [[ -d ~/.$PKG-venv/bin ]] && . ~/.$PKG-venv/bin/activate || . ~/.$PKG-venv/Scripts/activate; } && pip install -U pip wheel && pip install 'git+https://github.com/alexanderankin/side-projects.git@main#egg='"$PKG"'&subdirectory=misc/projects/json-converters' && for b in "${BINS[@]}"; do ln -s ~/.$PKG-venv/bin/$b ~/.local/bin/$b; done && deactivate
# PKG=ruff; BINS=(ruff); { [[ -d ~/.$PKG-venv ]] || python -m venv ~/.$PKG-venv; } && { [[ -d ~/.$PKG-venv/bin ]] && . ~/.$PKG-venv/bin/activate || . ~/.$PKG-venv/Scripts/activate; } && pip install -U pip wheel && pip install $PKG && for b in "${BINS[@]}"; do ln -s ~/.$PKG-venv/bin/$b ~/.local/bin/$b; done && deactivate
# PKG=uv; BINS=(uv); { [[ -d ~/.$PKG-venv ]] || python -m venv ~/.$PKG-venv; } && { [[ -d ~/.$PKG-venv/bin ]] && . ~/.$PKG-venv/bin/activate || . ~/.$PKG-venv/Scripts/activate; } && pip install -U pip wheel && pip install $PKG && for b in "${BINS[@]}"; do ln -s ~/.$PKG-venv/bin/$b ~/.local/bin/$b; done && deactivate
# PKG=poetry; BINS=(poetry); { [[ -d ~/.$PKG-venv ]] || python -m venv ~/.$PKG-venv; } && { [[ -d ~/.$PKG-venv/bin ]] && . ~/.$PKG-venv/bin/activate || . ~/.$PKG-venv/Scripts/activate; } && pip install -U pip wheel && pip install $PKG && for b in "${BINS[@]}"; do ln -s ~/.$PKG-venv/bin/$b ~/.local/bin/$b; done && deactivate
# PKG=oci-cli; BINS=(oci); { [[ -d ~/.$PKG-venv ]] || python -m venv ~/.$PKG-venv; } && { [[ -d ~/.$PKG-venv/bin ]] && . ~/.$PKG-venv/bin/activate || . ~/.$PKG-venv/Scripts/activate; } && pip install -U pip wheel && pip install $PKG && for b in "${BINS[@]}"; do ln -s ~/.$PKG-venv/bin/$b ~/.local/bin/$b; done && deactivate
